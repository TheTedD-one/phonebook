...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'DGciInjlEWaV02y0462eKQDztWFS2_ce',
            'baseUrl'=> '',
        ],
        'cache' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'admin' => 'admin/person/index',
                'admin/person/<id:\d+>' => 'admin/person/view',
                'admin/<controller>/<action>/<id:\d+>' => 'admin/<controller>/<action>',

                'index/<page:\d+>/<per-page:\d+>' => 'site/index',
                'detail/<id:\d+>' => 'site/detail',
                '<action>' => 'site/<action>',


                //'admin/<controller>' => 'admin/<controller>/action',
            ],
        ],
    ],
    'params' => $params,
